...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://localhost/ckeditorTest/ckfinder',
    'root'         => '/Applications/XAMPP/xamppfiles/htdocs/ckeditorTest/ckfinder', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
